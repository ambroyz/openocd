...
static const uint32_t a64_opcodes[ARMV8_OPC_NUM] = {
		...
		[READ_REG_TTBR0]	= ARMV8_MRS(SYSTEM_TTBR0_EL1, 0),
		[READ_REG_TTBCR]	= ARMV8_MRS(SYSTEM_TTBCR_EL1, 0),
		[READ_REG_SCTLR]	= ARMV8_MRS(SYSTEM_SCTLR_EL1, 0),
		[READ_REG_MAIR0]	= ARMV8_MRS(SYSTEM_TTBR0_EL1, 0),
		[READ_REG_MAIR1]	= ARMV8_MRS(SYSTEM_TTBR0_EL1, 0), /* TODO */
		[WRITE_REG_TTBR0]	= ARMV8_MSR_GP(SYSTEM_TTBR0_EL1, 0),
		[WRITE_REG_TTBCR]	= ARMV8_MSR_GP(SYSTEM_TTBCR_EL1, 0),
		[WRITE_REG_SCTLR]	= ARMV8_MSR_GP(SYSTEM_SCTLR_EL1, 0),
		[WRITE_REG_MAIR0]	= ARMV8_MSR_GP(SYSTEM_MAIR_EL1, 0),
		[WRITE_REG_MAIR1]	= ARMV8_MSR_GP(SYSTEM_MAIR_EL1, 0), /* TODO */
};
...
static const uint32_t t32_opcodes[ARMV8_OPC_NUM] = {
		...
		[READ_REG_TTBR0]	= ARMV4_5_MRC(15, 0, 0, 2, 0, 0),
		[READ_REG_TTBCR]	= ARMV4_5_MRC(15, 0, 0, 2, 0, 2),
		[READ_REG_SCTLR]	= ARMV4_5_MRC(15, 0, 0, 1, 0, 0),
		[READ_REG_MAIR0]	= ARMV4_5_MRC(15, 0, 0, 10, 2, 0),
		[READ_REG_MAIR1]	= ARMV4_5_MRC(15, 0, 0, 10, 2, 1),
		[WRITE_REG_TTBR0]	= ARMV4_5_MCR(15, 0, 0, 2, 0, 0),
		[WRITE_REG_TTBCR]	= ARMV4_5_MCR(15, 0, 0, 2, 0, 2),
		[WRITE_REG_SCTLR]	= ARMV4_5_MCR(15, 0, 0, 1, 0, 0),
		[WRITE_REG_MAIR0]	= ARMV4_5_MCR(15, 0, 0, 10, 2, 0),
		[WRITE_REG_MAIR1]	= ARMV4_5_MCR(15, 0, 0, 10, 2, 1),
};
